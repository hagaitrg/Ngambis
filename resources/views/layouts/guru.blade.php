            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/guru-materi-tables">Materi</a>
                        <a class="collapse-item" href="/guru-quiz-tables">Penilaian</a>
                        <a class="collapse-item" href="/guru-nilai-tables">Penilaian</a>
                    </div>
                </div>
            </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; ngambis 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
